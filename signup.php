...
<body>
				...
				<div class="col-sm-12">
					...
					<div class="bannerList" >
						<ul>
							...
							<li>
								<a href="classe.html">Classes
									<i class="fa fa-caret-right"></i>
								</a>
							</li>
							<li>
								<a href="singleClasse.html">Single
									<i class="fa fa-caret-right"></i>
								</a>
							</li>
						</ul>
	...
	<!-- ================================ -->
	<section class="presentaionSection singleClasse">
		<div class="presentationContent">
			<div class="container">
				<div class="row">
					<div class="col-sm-7">
						<div class="benefitsContent">
							<h3>SMART TURTLE CLASS:</h3>
							<p>
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec lacus nibh, vulputate eu dia
								non, sodales tincidunt ligula. Pellentesque molestie nisl in dolor gravida commodo. Lorem 
								ipsum dolor sit amet, consectetur adipiscing elit. Curabitur rhoncus nisi id felis fringilla et
								lobortis augue lobortis. Nunc at nibh scelerisque nisi varius egestas quis fringilla ut.
							</p>
						</div><!-- end benefitsContent-->

						<div class="benefits">
							<ul class="clearfix">
								<li class="col-sm-6">
									<i class="fa fa-graduation-cap"></i>
									<h4>12-24 months old</h4>
					...
					</div><!--end contentPresentation -->

					<div class="col-sm-5">
						<div class="carouselPresentation row">
							<div class="col-sm-12">
								<img src="assets/img/slide/sl1.jpg" alt="img">
							</div>
							<div class="col-sm-12">
								<img src="assets/img/content/shopslide1.jpg" alt="img">
							</div>
	...
	<!-- ========== ENTERTAINING ========== -->
	<!-- ================================ -->
	<section class="entertaining" style="background-image:url(assets/img/content/bgk1.jpg);margin-top:12rem;border-top:1px solid #ececec; border-bottom:1px solid #ececec;">
		<div class="container">
